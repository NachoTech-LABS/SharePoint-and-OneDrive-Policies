...
# NACHOTECH'S M365 Secure Configuration Baseline for SharePoint Online and OneDrive
...
NachoTech adapts leading security guidance, including configuration baselines developed by the Cybersecurity and Infrastructure Security Agency (CISA) Secure Cloud Business Applications (SCuBA) project, to help organizations secure their cloud business application environments and protect information that is created, accessed, shared, and stored in those environments.

The M365 secure configuration baselines we use are designed to help protect information assets stored within Microsoft 365 through consistent, effective, and manageable security configurations. While some of this guidance was originally tailored to U.S. federal agencies, the same principles are highly useful for nonprofits, small businesses, and other organizations that want to reduce risk from data exposure, account compromise, and misconfigured sharing

 The information and recommendations provided by NachoTech are offered for general informational and best-practice purposes only. They may need to be adapted to your organization’s specific environment, licensing, risk tolerance, and regulatory requirements. Some controls and settings may not be available in all Microsoft 365 plans or products, and vendors may change features over time.

> This material does not constitute legal, regulatory, or compliance advice, and does not by itself ensure compliance with any law, regulation, or contractual obligation. Each organization remains responsible for meeting its own recordkeeping, privacy, and other legal requirements..
...
**Automated Check**: This configuration can be automatically checked using CISA’s ScubaGear tool or equivalent security assessment tooling used by NachoTech.
